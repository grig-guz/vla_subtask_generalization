...
def get_config(config_string="full,multimodal"):
    ...
    FINETUNING_KWARGS = {
        ...
        #"num_parallel_reads": 4,  # for reading from disk / GCS
    ...
    config = dict(
        ...
        ann_file_path=placeholder(str),
        do_subsampling=placeholder(bool),
        jax_compilation_path=placeholder(str),
        seed=42,
        wandb=dict(
        ...
        optimizer=dict(
            ...
            grad_accumulation_steps=placeholder(int),  # if you are using grad accumulation, you need to adjust max_steps accordingly
        ),
        val_kwargs=dict(
    ...
    config['calvin_config_path'] = placeholder(str)
