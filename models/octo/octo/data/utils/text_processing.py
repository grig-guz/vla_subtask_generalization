...
class HFTokenizer(TextProcessor):
    def __init__(
        ...
        try:
            ...
            print("Loading failed due to proxy error (due to running on sockeye cluster), loading from hardcoded cache.")
            self.tokenizer = AutoTokenizer.from_pretrained(tokenizer_name, _commit_hash='a9723ea7f1b39c1eae772870f3b547bf6ef7e6c1')
