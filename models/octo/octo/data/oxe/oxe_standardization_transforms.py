...
def calvin_dataset_transform(trajectory: Dict[str, Any]) -> Dict[str, Any]:
    # gripper action is in -1 (close)...1 (open) --> clip to 0...1 --> +1 = open, 0 = close
    gripper_action = trajectory["action"][:, -1:]
    gripper_action = tf.clip_by_value(gripper_action, 0, 1)
    ...
    trajectory["observation"]["proprio"] = tf.concat(
        [
            ...
            trajectory["observation"]["scene_state"]
        ],
        axis=1,
    )
...
OXE_STANDARDIZATION_TRANSFORMS = {
    ...
    "calvin_high_level": calvin_dataset_transform,
    "calvin_conj": calvin_dataset_transform,
    "calvin_low_level": calvin_dataset_transform,
