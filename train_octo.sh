...
ANN_FILE_PATH="." # for bootstrap experiments

# NOTE: The code automatically detects the number of GPUs available and splits the batch so the batch size on each GPU is GLOBAL_BATCH_SIZE/num_gpus 
